...
class _RecipeListState extends State<RecipeList> {
  ...
  Future loadRecipes() async {
    // 1 Loads "recipes1.json" from the "assets" directory. "rootBundle" is
    // the top-level property that holds references to all the items in the
    // asset folder. This loads the file as a string.
    final jsonString = await rootBundle.loadString('assets/recipes1.json');
    setState(() {
      // 2 Uses the build-in "jsonDecode()" method to convert the string to a
      // map, then uses "fromJson()", which was generated for you, to make an
...
Widget _buildRecipeCard(
  ...
  return GestureDetector(
    ...
    // 2 Calls "recipeStringCard()", which shows a nice card below the
    // search field.
